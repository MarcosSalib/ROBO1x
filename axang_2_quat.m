%%  In this script, you need to convert the axis-angle representation into
%%  quaternion form.
%%  Your final solution for the quaternion representation must be stored in quat
%%  If the quaternion is Qs + Qx i + Qy j + Qz k, it should be stored as
%%  [Qs,Qx,Qy, Qz]
...
for i = 1:24
    ...
    quat = [cos(theta./2), vec.*sin(theta./2)]
